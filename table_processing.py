...
def upload_excel_number_of_subjects(file_path, sheet_name, class_name):
...
if __name__ == '__main__':
    ...
    # upload_excel_number_of_subjects(path_file, 'preprocessed_OR', "AD")
    # upload_excel_number_of_subjects(path_file, 'preprocessed_OR', "CN")
